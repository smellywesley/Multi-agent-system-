...
class LLMClient:
    ...
    def generate_structured(self, prompt: str, schema: Type[BaseModel], use_heavy_model: bool = False) -> Any:
        ...
        # THE FIX: Absolute Silence Directive
        prompt += "\n5. STRICT JSON ONLY: You are a machine pipeline. Do NOT add conversational text, comments, or notes in parentheses inside or outside the JSON. Your output must be 100% parsable by json.loads()."
